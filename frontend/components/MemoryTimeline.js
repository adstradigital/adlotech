...
const timelineData = [
  {
    ...
    description: 'Our expert instructor guiding interns through real-time Python programming concepts in an interactive classroom environment. Students actively engage with practical coding exercises, building strong foundations in software development.',
  ...
  },
  {
    ...
    description: 'Our expert instructor providing one-on-one support to interns by resolving doubts in real time. Students gain deeper clarity through personalized explanations and hands-on problem solving, strengthening their confidence in Python development.',
  ...
  },
  {
    ...
    description: 'Students learn to build real-world websites using Python while collaborating with our team on live projects. This hands-on approach helps them gain practical experience, teamwork skills, and industry-ready development knowledge.',
  ...
  },
  {
    ...
    description: 'Students get the opportunity for direct placement based on their performance during the training program. Top performers are selected to work with our team, gaining real-world experience and launching their careers in software development.',
